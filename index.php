    ...
    <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel" style="width: 250px;">
      ...
      <div class="offcanvas-body">
        <ul class="navbar-nav nav-pills flex-column justify-content-end flex-grow-1">
          ...
          <li class="nav-item ">
            <a class="nav-link link-dark" href="#"><i class="bi bi-menu-app-fill"></i> Daftar Menu</a>
          </li>
          <li class="nav-item ">
            <a class="nav-link link-dark" href="#"><i class="bi bi-tags"></i> Kategori Menu</a>
          </li>
          <li class="nav-item ">
            <a class="nav-link link-dark" href="#"><i class="bi bi-cart4"></i> Order</a>
          </li>
          <li class="nav-item ">
            <a class="nav-link link-dark" href="#"></i><i class="bi bi-fire"></i> Dapur</a>
          </li>
          <li class="nav-item ">
            <a class="nav-link link-dark" href="#"><i class="bi bi-person-fill"></i> User</a>
          </li>
          <li class="nav-item ">
            <a class="nav-link link-dark" href="#"><i class="bi bi-journals"></i> Report</a>
          </li>
        </ul>
      </div>
    </div>
